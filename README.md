...
Twenty (20) phytochemicals were retrieved from the plant *Urtica dioica* Out of which 7 phytochemicals were selected; 34 phytochemicals from *Trigonella foenum-graecum* out of which 29 were accepted; 61 phytochemicals were retrieved from *Momordica charantia*; 154 phytochemicals were retrieved from *Salvia officinalis*; 48 phytochemicals were retrieved from the plant *Glycyrrhiza glabra* and 61 phytochemicals were retrieved from the plant *Moringa oleifera*. The results for each of the extracted phytochemicals shows the various physicochemical properties on which basis the compounds were screened. The properties comprise hydrogen bond acceptors, hydrogen bond donors, logP and molecular weight.
